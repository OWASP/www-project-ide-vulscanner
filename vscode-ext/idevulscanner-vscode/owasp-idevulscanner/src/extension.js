...
function activate(context) {
    ...
    const lintCommand = vscode.commands.registerCommand("extension.lintWithSpectral", () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield spectral.setRuleset(ruleset);
            const results = yield spectral.run(text);
            diagnostics_1.DiagnosticCollection.updateDiagnostics(document, results, diagnostics);
        }
        catch (error) {
